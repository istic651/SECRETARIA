        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                    ...
                    <ul class="sidebar-menu">
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="../forms/horariosPrimerAnio.php"><i class="fa fa-angle-double-right"></i> Primer Año </a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="alumnos.php"><i class="fa fa-angle-double-right"></i> Inscripción Alumnos</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="../forms/inscripcionProfesores.php"><i class="fa fa-angle-double-right"></i> Inscripción Profesores</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Eliminar materia
                        <small>Elimne la materia elegida</small>
                    </h1>
                    <ol class="breadcrumb">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="docenteId" name="CodMateria" placeholder="ingrese código materia">
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                </div><!-- /.box-body -->
                                    <div class="buttons">
